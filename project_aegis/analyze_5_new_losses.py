...
losses_dir = r'C:\Users\GauravPatel\Downloads\aegis_replays\losses'
new_losses = ['95908087.json', '95910381.json', '95912583.json', '95914960.json', '95917252.json']

print("=" * 80)
print(f"PREVIOUS LIVE AGENT LOSSES AUDIT ({len(new_losses)} MATCHES)")
print("=" * 80)

for f in new_losses:
    file_path = os.path.join(losses_dir, f)
