...
if __name__ == '__main__':
    ...
    seeds = [1, 2, 3, 4, 5, 42, 100, 101, 202, 303, 555, 777, 888, 999, 1234]
    
    # 1. Test v50 (P0) vs main2 (P1)
    run_bench_sync(agent_v50, agent_main2, seeds)
    # 2. Test main2 (P0) vs v50 (P1)
    run_bench_sync(agent_main2, agent_v50, seeds)
