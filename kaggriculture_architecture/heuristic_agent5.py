...
def agent(obs, config=None):
    ...
    if step < 24 and len(market_action) < 10:
        if cows < 2 and cash >= 400 and len(market_action) < 10:
            market_action.append(["BUY_ANIMAL", "COW", 1])
            cash -= 400
        elif sheep < 2 and cash >= 500 and len(market_action) < 10:
            market_action.append(["BUY_ANIMAL", "SHEEP", 1])
            cash -= 500
        elif melon_seeds < 12 and cash >= 80 and len(market_action) < 10:
